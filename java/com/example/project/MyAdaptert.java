...
public class MyAdaptert extends RecyclerView.Adapter<MyAdaptert.ViewHolder> {
    ...
    public MyAdaptert(List<MyList> myLists, Context context,RecyclerViewClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_t,parent,false);
