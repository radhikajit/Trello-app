...
public class Teacher extends AppCompatActivity {
    ...
    private MyAdaptert adapter;
    private FloatingActionButton add;
    private MyAdaptert.RecyclerViewClickListener listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                adapter=new MyAdaptert(myLists,getApplicationContext(),listener);
        ...
        add.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                View viewInflated = LayoutInflater.from(Teacher.this).inflate(R.layout.dialogbox, null);
// Set up the input
...
// Set up the buttons
    ...
    private void setOnClickListener() {
        listener=new MyAdaptert.RecyclerViewClickListener() {
            @Override
